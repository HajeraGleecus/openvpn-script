...
yum install firewalld --enablerepo=base,updates,epel -y
check_exit_status "Failed to install firewalld"

systemctl enable firewalld
check_exit_status "Failed to enable firewalld"

systemctl start firewalld
check_exit_status "Failed to start firewalld"
